...
import { Search, Calendar, Star, Heart, ShoppingCart, User } from "lucide-react"
...
const Homepage = () => {
  const tourCards = [
    ...
    {
      id: 3,
      image: "/ppp/4f575727-7e5c-47a8-87ee-2f7fc48685ac.jpg",
      title: "ทะเล",
      rating: 4.2,
      reviews: 250,
      capacity: "30/50",
    ...
    <div className="min-h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
          ...
          <div className="bg-white rounded-full p-2 flex items-center w-full max-w-3xl gap-2">
            <div className="flex-1 flex items-center px-4 border-r">
              ...
              <input type="text" placeholder="Where to?" className="w-full outline-none text-gray-700" />
            </div>
            <div className="flex-1 flex items-center px-4">
              <Calendar className="w-5 h-5 text-gray-400 mr-2" />
              <input type="text" placeholder="When?" className="w-full outline-none text-gray-700" />
            </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-[#2A8470] mb-1">Free cancellation</h2>
      ...
      <footer className="bg-gray-100 py-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <Image src="/logo.svg" alt="PET Travel Logo" width={120} height={120} className="object-contain" />
            <div className="text-center md:text-left">
              <p className="text-gray-600">15 KANCHANAWANICH ROAD, KHO HONG, HAT</p>
              <p className="text-gray-600">YAI DISTRICT, SONGKHLA 90110, THAILAND</p>
            </div>
            <div className="text-center md:text-left">
